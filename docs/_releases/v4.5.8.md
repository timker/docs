...
for easily modify active subscriptions and querying the state of subscribed channels as well as built-in heartbeats 
...
individual Rogue plugin wont prevent your ServiceStack AppHost from starting. But when a plugin doesn't 
