...
[announced earlier this year](?id=v4-0-54#warning-net-40-builds-will-cease-after-august-1-2016). 
...
[Add ServiceStack Reference](?id=Add-ServiceStack-Reference) and
ServiceStack's [.NET Service Clients](?id=CSharp-client)
...
# [v4.0.62 Release Notes](?id=v4-0-62)
