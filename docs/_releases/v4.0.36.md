...
Our enhancements to [Add ServiceStack Reference](/add-servicestack-reference) continue, this time extended to support [Xamarin Studio!](http://xamarin.com/studio)
