...
ServiceStack's [AutoQuery](/autoquery) feature already
...
AutoQuery's [Customizable Fields](/autoquery#customizable-fields)
...
[Request Filter attribute](/filter-attributes)
...
As a normal [Request Filter Attribute](/filter-attributes)
