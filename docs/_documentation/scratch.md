...
<tr>
    ...
    <td>
        ...
        <table>
            ...
            <tr>
              <td>Live Demo:</td>
              <td><a href="http://mvc.servicestack.mvc">mvc.servicestack.net</a></td>
            </tr>
            <tr>
              <td>Github:</td>
...
<tr>
  <td colspan="2">
    <b>Imgur</b> - AngularJS Single Page App leveraging AutoQuery in <50 lines of JavaScript + 1 AutoQuery DTO
  </td>
</tr>
<tr>
    <td>
...
<tr>
  <td colspan="2">
    <b>SimpleAuth.Mvc</b> - Simple demo showcasing integration and authentication with ServiceStack from ASP.NET Core MVC
  </td>
</tr>
<tr>
    <td>
...
<tr>
  <td colspan="2">
    <b>Northwind</b> - database viewer, easily create data-driven, AutoQuery and Cached services with ServiceStack + OrmLite
  </td>
</tr>
<tr>
    <td>
