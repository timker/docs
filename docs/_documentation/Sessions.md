...
## Can be used with any [ICacheClient](https://github.com/ServiceStack/ServiceStack/wiki/Caching)

ServiceStack's implementation of Sessions are clean, in that they work with all of [ServiceStack's Caching Providers](https://github.com/ServiceStack/ServiceStack/wiki/Caching) and are simply pointers to POCOs in your Cache. An example of getting ServiceStack to use an in-memory cache:
